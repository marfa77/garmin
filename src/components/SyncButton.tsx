...
export function SyncButton() {
  ...
  return (
    <div className="relative">
      ...
      {syncError && (
        <p className="absolute right-0 top-full z-30 mt-2 max-w-[220px] rounded-lg border border-rose-900/50 bg-zinc-950 px-3 py-2 text-[11px] leading-snug text-rose-300 shadow-lg">
          {syncError === "cloud" ? t.sync.cloudHint : syncError}
        </p>
      )}
    </div>
  );
